...
public func routes(_ app: Application) throws {
    ...
    try app.register(collection: WebSearchPageController())
    try app.register(collection: WebSearchController(search: searching))
    try app.register(collection: WebDeletePageController())
    try app.register(collection: WebDeleteController(delete: deleting))
    try app.register(collection: WebUpdatePageController())
